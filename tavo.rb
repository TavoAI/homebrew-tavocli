class Tavo < Formula
  ...
  url "https://github.com/TavoAI/tavo-cli/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "161194f8f80e1a93c74dc511ead4e51a44596c24efab8717026780ef939e0d17"
  license "MIT"
  ...
  test do
    assert_match "TAVO - Open Policy Agent Verification and Testing CLI tool", shell_output("#{bin}/tavo --help")
    assert_match "Commands related to the OPA policy server", shell_output("#{bin}/tavo server --help")
    assert_match "Start the server in development mode", shell_output("#{bin}/tavo server start-dev --help")
  end
end 